...
namespace TVMaze.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ApplicationContext>(opts => opts.UseSqlServer(Configuration["ConnectionString:TVMazeDatabase"]));
            services.AddScoped<IRepository<ShowModel>, ShowCastManager>();            
